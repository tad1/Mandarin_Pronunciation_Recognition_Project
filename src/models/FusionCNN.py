...
class ContextFusionCNN(nn.Module):
    """
    2D and 1D CNN with word embedding for context
    """

    def __init__(self, n_2d_channels, n_1d_channels, num_classes=1, num_words=30, dropout_rate=0.3):
    ...
    # Note, there's a coupling between dataframe casting and model input
...
class ContextCNN(nn.Module):
    """
    2D CNN with word embedding for context
    """

    def __init__(self, n_2d_channels=1, num_classes=1, num_words=30, dropout_rate=0.3):
