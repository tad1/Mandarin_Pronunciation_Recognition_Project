...
(the binary assessment of mandarin pronuncation of L2 Polish speakers)
...
TODO: confusion matrix (human vs machine) for test results
...
\section{Discussion}
(while the multi modal didn't increased, the performance )
(an additional research is needed to determine whenever it's a problem with information redundancy, or with the architecture)
()
